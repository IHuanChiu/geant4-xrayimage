...
if __name__=="__main__":
   fout = ROOT.TFile("./output_eff_plots.root","recreate")

   f1=ROOT.TFile("./G4_MCsample/Output_white_xray_angle.root","read"); width, _name=0.5, "eff_white"
   #f1=ROOT.TFile("./G4_MCsample/Output_black_xray_angle.root","read"); width, _name=0.5, "eff_black"
   #f1=ROOT.TFile("./G4_MCsample/Output_dew_xray_angle.root","read"); width, _name=1.75, "eff_dew"
   #f1=ROOT.TFile("./G4_MCsample/Output_dew35_xray_angle.root","read"); width, _name=1.75, "eff_dew_35"
   tree=f1.Get("tree")
   for i in range(6):
