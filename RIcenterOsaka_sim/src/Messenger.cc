...
{ 
  ...
  Ignore3Cmd = new G4UIcmdWithAString("/command/rot",this);
  ...
  Ignore4Cmd = new G4UIcmdWithAString("/command/chID",this);
  Ignore4Cmd->SetGuidance("This command is ignored by the messenger, but used for the detector construction.");
  Ignore4Cmd->AvailableForStates(G4State_PreInit,G4State_Idle);
}
